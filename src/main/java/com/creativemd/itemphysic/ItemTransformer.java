...
public class ItemTransformer implements IClassTransformer {
    ...
    public static final String[] names = new String[] { ".", "doRender", "net/minecraft/entity/Entity",
        "renderWithColor", "net/minecraft/client/renderer/entity/RenderItem", "net/minecraft/entity/item/EntityItem",
        "onUpdate", "isBurning", "attackEntityFrom", "net/minecraft/util/DamageSource", "health", "onCollideWithPlayer",
        "net/minecraft/entity/player/EntityPlayer", "net/minecraft/util/AxisAlignedBB", "getCollisionBox",
        "canBeCollidedWith", "net/minecraft/client/entity/EntityClientPlayerMP", "dropOneItem",
        "setPositionAndRotation2", "interactFirst" };
    public static final String[] namesOb = new String[] { "/", "a", "sa", "a", "bny", "xk", "h", "al", "a", "ro", "e",
        "b_", "yz", "azt", "h", "R", "bjk", "a", "a", "c" };
    ...
    public byte[] transform(String arg0, String arg1, byte[] arg2) {
        if (arg0.equals("bny") | arg0.contains("net.minecraft.client.renderer.entity.RenderItem")) {
            ...
            arg2 = replaceMethodDoRender(
                arg0,
                arg2,
                ItemPatchingLoader.location,
                !arg0.contains("net.minecraft.client.renderer.entity.RenderItem"));
        }
        if (!isLite) {
            if (arg0.equals("xk") | arg0.equals("net.minecraft.entity.item.EntityItem")) {
                System.out.println("[ItemPhysic] Patching " + arg0);
                arg2 = replaceMethodOnUpdate(
                    arg0,
                    arg2,
                    ItemPatchingLoader.location,
                    !arg0.equals("net.minecraft.entity.item.EntityItem"));
                arg2 = addMethodIsBurning(
                    arg0,
                    arg2,
                    ItemPatchingLoader.location,
                    !arg0.equals("net.minecraft.entity.item.EntityItem"));
                arg2 = addMethodSetPosition(
                    arg0,
                    arg2,
                    ItemPatchingLoader.location,
                    !arg0.equals("net.minecraft.entity.item.EntityItem"));
                arg2 = replaceMethodAttack(
                    arg0,
                    arg2,
                    ItemPatchingLoader.location,
                    !arg0.equals("net.minecraft.entity.item.EntityItem"));
            ...
            if (arg0.equals("bjk") | arg0.equals("net.minecraft.client.entity.EntityClientPlayerMP")) {
                ...
                arg2 = removeDrop(
                    ...
                    arg2,
                    ItemPatchingLoader.location,
                    !arg0.equals("net.minecraft.client.entity.EntityClientPlayerMP"));
            }
        }
        return arg2;
    }
    ...
    public byte[] addMethodSetPosition(String name, byte[] bytes, File location, boolean obfuscated) {
        ...
        m.instructions.add(
            new MethodInsnNode(
                ...
                "com/creativemd/itemphysic/physics/ServerPhysic",
            ...
            if ((m.name.equals(targetMethodName) && m.desc.equals(targetDESC))) {
                ...
                while (iter.hasNext()) {
                    ...
                    if (currentNode instanceof MethodInsnNode) {
                         ...
                         * m.instructions.insertBefore(currentNode, new FieldInsnNode(Opcodes.GETFIELD,
                         * name.replace(".", "/"), targetVar, "Z"));
                         */
    ...
    public byte[] replaceMethodAttack(String name, byte[] bytes, File location, boolean obfuscated) {
         ...
         * method2.instructions.add(new MethodInsnNode(INVOKESTATIC, "com/creativemd/itemphysic/physics/ServerPhysic",
         * "canBeCollidedWith", "()Z"));
         ...
         * method2.localVariables.add(new LocalVariableNode("this", "L" + name.replace(".", "/") + ";", null, label3,
         * label4, 0));
