...
public class SulfuricAcidListRegistry {
    ...
    public static class SulfuricAcidList {
        ...
        public SulfuricAcidList(Item item, int metadata, boolean ignoremeta) {
            this.item = item;
        ...
        if (ItemPhysicConfig.sulfuricAcidList != null) {
            for (String itemName : ItemPhysicConfig.sulfuricAcidList) {
                ...
                if (parts.length >= 2) {
                    ...
                    if (item != null) {
                        SulfuricAcidListRegistry.SulfuricAcidList Item = new SulfuricAcidListRegistry.SulfuricAcidList(
                            item,
                            metadata,
                            ignoremeta);
                        SulfuricAcidListRegistry.SulfuricAcidItems.add(Item);
                    }
